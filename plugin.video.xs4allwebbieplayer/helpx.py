...
class Gui(xbmcgui.WindowXMLDialog):
    ...
    def set_help_text(self):
        ...
        helpText += '\n[COLOR gray]Als u via draadloos internet kijkt zorg er dan voor dat u een goed signaal heeft anders kunt u storingen zoals haperingen krijgen tijdens het tv kijken, u kunt de maximale beeld kwaliteit verlagen in de add-on instellingen.[/COLOR]'
        ...
        helpText += '\n\nGebruik deze add-on op eigen risico'
        helpText += '\n[COLOR gray]Als er een DDoS aanval wordt uitgevoerd op de interactieve tv server kan deze add-on door een onbekende reden als aanvaller beschouwt worden en is er een kleine kans dat uw internet verbinding tijdelijk kan worden uitgeschakeld door uw provider.[/COLOR]'

        helpText += '\n\nRadio zender werkt niet meer'
        helpText += '\n[COLOR gray]Als een bepaalde radio zender niet meer werkt kunt u dit aan de ontwikkelaar van deze add-on melden via https://contact.arnoldvink.com zodat de radio zender aangepast kan worden in de lijst.[/COLOR]'
